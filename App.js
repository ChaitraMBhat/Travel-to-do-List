...
function Form({ onAddItems }){
    ...
    return(
        <form className="add-form" onSubmit={handleSubmit}>
            ...
            <input type="text" placeholder="Item..." value={des} onChange={(e) => setDes(e.target.value)}/>
            <button>Add</button>
        </form>
    );
}
...
function PackingList({ items, onDeleteItem, onToggleItem, onClear }){
    ...
    if (sortBy === "description") sortedItems = items.slice().sort((a,b) => a.des.localeCompare(b.des));
